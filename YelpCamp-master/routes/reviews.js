...
router.get("/", function (req, res) {
    Campground.findById(req.params.id).populate({
        ...
        res.render("reviews/index", {campground: campground,page:"reviewIndex"});
    });
});
...
router.get("/new", middleware.isLoggedIn, middleware.checkReviewExistence, function (req, res) {
    ...
    Campground.findById(req.params.id, function (err, campground) {
        ...
        res.render("reviews/new", {campground: campground,page:"reviewNew"});
...
router.get("/:review_id/edit", middleware.checkReviewOwnership, function (req, res) {
    Review.findById(req.params.review_id, function (err, foundReview) {
        ...
        res.render("reviews/edit", {campground_id: req.params.id, review: foundReview,page:"reviewEdit"});
    });
});
